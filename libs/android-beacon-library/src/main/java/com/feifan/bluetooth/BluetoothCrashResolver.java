 ...
 * Bluetooth LE devices in the background (e.g. com.my.com.my.com.mm.beacon-enabled apps), especially when these users
...
public class BluetoothCrashResolver {
     ...
     * @deprecated Since the default logger used by the android-com.my.com.my.com.mm.beacon-library only logs warnings and
     * above, this method is no logger used. To log debug messages use the
     * {@link com.feifan.beacon.logging.Loggers#verboseLogger()}
     * @see com.feifan.beacon.logging.LogManager
     * @see com.feifan.beacon.logging.Loggers
     */
    @Deprecated
