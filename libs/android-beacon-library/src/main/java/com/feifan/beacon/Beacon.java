...
import com.feifan.beacon.client.BeaconDataFactory;
import com.feifan.beacon.client.NullBeaconDataFactory;
import com.feifan.beacon.distance.DistanceCalculator;
import com.feifan.beacon.logging.LogManager;
...
public class Beacon implements Parcelable {
    ...
    /**
     * The a list of the multi-part identifiers of the com.my.com.my.com.mm.beacon.  Together, these identifiers signify
     * a unique com.my.com.my.com.mm.beacon.  The identifiers are ordered by significance for the purpose of grouping
     * beacons
     */
    protected List<Identifier> mIdentifiers;

    /**
     * A list of generic non-identifying data fields included in the com.my.com.my.com.mm.beacon advertisement.  Data
     * fields are limited to the size of a Java long, or six bytes.
     */
    protected List<Long> mDataFields;
    /**
     * A list of generic non-identifying data fields included in a secondary com.my.com.my.com.mm.beacon advertisement
     * and merged into this com.my.com.my.com.mm.beacon.  Data fields are limited to the size of a Java long, or six
     * bytes.
     */
    ...
    /**
     * The two byte value indicating the type of com.my.com.my.com.mm.beacon that this is, which is used for figuring
     * out the byte layout of the com.my.com.my.com.mm.beacon advertisement
     */
    protected int mBeaconTypeCode;

    /**
     * A two byte code indicating the com.my.com.my.com.mm.beacon manufacturer.  A list of registered manufacturer codes
     * may be found here:
     * https://www.bluetooth.org/en-us/specification/assigned-numbers/company-identifiers
     *
     * If the com.my.com.my.com.mm.beacon is a GATT-based com.my.com.my.com.mm.beacon, this field will be set to -1
     */
    protected int mManufacturer;

    /**
     * A 32 bit service uuid for the com.my.com.my.com.mm.beacon
     *
     * This is valid only for GATT-based beacons.   If the com.my.com.my.com.mm.beacon is a manufacturer data-based
     * com.my.com.my.com.mm.beacon, this field will be -1
     */

    protected int mServiceUuid = -1;

    /**
     * The Bluetooth device name.  This is a field transmitted by the remote com.my.com.my.com.mm.beacon device separate
     * from the advertisement data
     */
    protected String mBluetoothName;

    /**
     * The identifier of the beaconParser used to create this com.my.com.my.com.mm.beacon.  Useful for figuring out
     * com.my.com.my.com.mm.beacon types.
     */
    ...
    /**
     * Sets the DistanceCalculator to use with this com.my.com.my.com.mm.beacon
     * @param dc
     */
    ...
    /**
     * Gets the DistanceCalculator to use with this com.my.com.my.com.mm.beacon
     */
     ...
     * to be configured equal.  This setting applies to all com.my.com.my.com.mm.beacon instances in the same process.
    ...
    /**
     * Provides a calculated estimate of the distance to the com.my.com.my.com.mm.beacon based on a running average of
     * the RSSI and the transmitted power calibration value included in the com.my.com.my.com.mm.beacon advertisement.
    ...
    /**
     * Calculate a hashCode for this com.my.com.my.com.mm.beacon
     * @return
     */
    @Override
    public int hashCode() {
    ...
    /**
     * Requests server-side data for this com.my.com.my.com.mm.beacon.  Requires that a BeaconDataFactory be set up with
     * a backend service.
    ...
    /**
     * Formats a com.my.com.my.com.mm.beacon as a string showing only its unique identifiers
     * @return
     */
    @Override
    ...
    /**
     * Indicates whether this com.my.com.my.com.mm.beacon is an "Extra data com.my.com.my.com.mm.beacon," meaning one that has no identifiers
     * but has data fields.
     * @return
     */
    ...
    /**
     * Estimate the distance to the com.my.com.my.com.mm.beacon using the DistanceCalculator set on this class.  If no
     * DistanceCalculator has been set, return -1 as the distance.
     * @see com.feifan.beacon.distance.DistanceCalculator
     *
     * @param txPower
     ...
     *
     * <pre>
     * Beacon com.my.com.my.com.mm.beacon = new Beacon.Builder()
    ...
    public static class Builder {
        ...
        /**
         * Builds an instance of this com.my.com.my.com.mm.beacon based on parameters set in the Builder
         * @return com.my.com.my.com.mm.beacon
         */
        public Beacon build() {
            if (mId1!= null) {
        ...
        /**
         * @param beacon the com.my.com.my.com.mm.beacon whose fields we should copy to this com.my.com.my.com.mm.beacon builder
         * @return
         */
        ...
        /**
         * Convenience method allowing the first com.my.com.my.com.mm.beacon identifier to be set as a String.  It will
        ...
        /**
         * Convenience method allowing the second com.my.com.my.com.mm.beacon identifier to be set as a String.  It will
         * be parsed into an Identifier object
        ...
        /**
         * Convenience method allowing the third com.my.com.my.com.mm.beacon identifier to be set as a String.  It will
         * be parsed into an Identifier object
