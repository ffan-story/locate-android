        ...
        synchronized (mRangedBeacons) {
            for (Beacon beacon : mRangedBeacons.keySet()) {
                ...
                if (!rangedBeacon.noMeasurementsAvailable() == true) {
                    //if TrackingCache is enabled, allow com.my.com.my.com.mm.beacon to not receive
                    ...
                    LogManager.d(TAG, "Dumping com.my.com.my.com.mm.beacon from RangeState because it has no recent measurements.");
                }
            }
