...
/**
 * A specific com.my.com.my.com.mm.beacon parser designed to parse only AltBeacons from raw BLE packets detected by
...
public class AltBeaconParser extends BeaconParser {
    ...
    public AltBeaconParser() {
        ...
        // this list, please open an issue on the Github project for this library.  If a com.my.com.my.com.mm.beacon
        // manufacturer code not in this list is used for AltBeacons, phones using Andoroid 5.x+
        // detection APIs will not be able to detect the com.my.com.my.com.mm.beacon in the background.
