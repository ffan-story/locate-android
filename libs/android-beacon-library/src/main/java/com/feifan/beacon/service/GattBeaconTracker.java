...
public class GattBeaconTracker {
    ...
    /**
     * Tracks a com.my.com.my.com.mm.beacon.  For Gatt-based beacons, returns a merged copy of fields from multiple
     * frames.  Returns null when passed a Gatt-based com.my.com.my.com.mm.beacon that has is only extra com.my.com.my.com.mm.beacon data.
     *
     * @param beacon
     * @return
     */
    ...
    private Beacon trackGattBeacon(Beacon beacon) {
        // If this is a service UUID based com.my.com.my.com.mm.beacon, we may need to merge fields, as
        ...
        if (matchingTrackedBeacons != null) {
            for (Beacon matchingTrackedBeacon: matchingTrackedBeacons.values()) {
                if (beacon.isExtraBeaconData()) {
                    ...
                    // replace the tracked com.my.com.my.com.mm.beacon instance with this one so it has updated values
                    trackedBeacon = beacon;
                }
            }
        }
