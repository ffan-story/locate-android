...
import com.feifan.beacon.logging.Loggers;
import com.feifan.beacon.service.BeaconService;
import com.feifan.beacon.service.RangeState;
import com.feifan.beacon.service.RangedBeacon;
import com.feifan.beacon.service.RunningAverageRssiFilter;
import com.feifan.beacon.service.StartRMData;
import com.feifan.beacon.service.scanner.NonBeaconLeScanCallback;
import com.feifan.beacon.simulator.BeaconSimulator;
 ...
 *                  if (beacons.size() > 0) {
 *                      Log.i(TAG, "The first com.my.com.my.com.mm.beacon I see is about "+beacons.iterator().next().getDistance()+" meters away.");
 *                  }
 *              }
 *          });
 *
...
public class BeaconManager {
     ...
     * {@link com.feifan.beacon.logging.LogManager#setLogger(com.feifan.beacon.logging.Logger)}
     * instead.
     */
    @Deprecated
   ...
   /**
    ...
    /**
     * Tells you if the passed com.my.com.my.com.mm.beacon consumer is bound to the service
     *
     * @param consumer
     * @return
     */
    ...
    /**
     * Tells you if the any com.my.com.my.com.mm.beacon consumer is bound to the service
     *
     * @return
     */
    ...
    /**
     * This method notifies the com.my.com.my.com.mm.beacon service that the application is either moving to background
     ...
     * {@link com.feifan.beacon.logging.LogManager#d(String, String, Object...)} instead.
     */
    @Deprecated
     ...
     * @param t
     * @deprecated This will be removed in a later release. Use
     * {@link com.feifan.beacon.logging.LogManager#d(Throwable, String, String, Object...)}
     * instead.
     */
    @Deprecated
    ...
    /**
     * Set the period of time, in which a com.my.com.my.com.mm.beacon did not receive new
     * measurements
