...
//                handleScanData(getBeacons());
    ...
    public void initialize(Context context) {
        ...
        // 初始化广场和楼层
        ResultReceiver plazaReceiver = new ResultReceiver(new Handler(Looper.getMainLooper())){
            @Override
...
//                        mLocationModel.locationInfo.plazaName = info.plazaName;
        ...
        Intent intent = new Intent(context, PlazaDetectorService.class);
