...
import com.feifan.locate.sampling.DataFixer;
 ...
 */
public class SpotDetailFragment extends AbsSensorFragment implements SampleSpotAdapter.OnSampleSpotClickListener {
...
//                    mSampleSpotId = SampleSpot.add(getContext(), mPoint.getRawX(), mPoint.getRawY(), mDegree, mPoint.id);
    ...
    protected int getLoaderId() {
        return Constants.LOADER_ID_SAMPLESPOT;
    }
