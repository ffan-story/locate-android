...
public class BeaconScanner implements LeScanCallback {
    ...
    private List<OnBeaconCallback> mCallbacks = new ArrayList<>();
    ...
    public void start(OnBeaconCallback callback) {
        if(mAdapter != null) {
    ...
    public void onLeScan(BluetoothDevice bluetoothDevice, int i, byte[] bytes) {
        ...
        for(OnBeaconCallback callback : mCallbacks) {
            callback.onBeaconScan(mData);
        }
    }
