...
public class RealtimePlanFragment extends AbsLoaderFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onAttach(Context context) {
        ...
        // temp
//        String addr = LocatePreferences.getInstance().getLocateAddr();
//        int port = LocatePreferences.getInstance().getLocatePort();
//        if(port != 0) {
//            ServerConfig.SERVER_ADDR = String.format("http://%s:%d", addr, port);
//            LogUtils.i("locate server changed to " + ServerConfig.SERVER_ADDR);
//        }
