...
public class SensorScanFragment extends BaseFragment implements OnCheckedChangeListener,
        View.OnClickListener, OnSharedPreferenceChangeListener, SensorDataCallback {
    ...
    public void onAttach(Context context) {
        ...
        String path = context.getExternalCacheDir().getAbsolutePath().concat(File.separator);
    ...
    public void onDataChanged(long timeStamp, SensorData data) {
        mExporter.writeLine(System.currentTimeMillis() + "," + data.toString());
        DebugWindow.get().logI(data.orientation.toString());
    }
