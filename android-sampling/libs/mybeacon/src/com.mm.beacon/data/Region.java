...
public class Region  {
	...
	public Region(String uniqueId, String proximityUuid, Integer major, Integer minor) {
		this(uniqueId,proximityUuid,major,minor,-1);
	}
	 ...
	 * @param minor
	 */
	public Region(String uniqueId, String proximityUuid, Integer major, Integer minor, double accuracy) {
		this.major = major;
		this.minor = minor;
	...
	public void makeRegionInside(){
		setmMatchNum(REGION_MATCHED_NUM);
	}

	public void makeRegionOutSide(){
		setmMatchNum(REGION_UNMATCHED_NUM);
	}
	...
	public boolean matchesIBeacon(IBeacon iBeacon) {
		...
		if(accuracy != -1 && iBeacon.getAccuracy() > accuracy){
			return false;
		}
		return true;
	}
	...
	private int mMatchNum = 0;
	private final int REGION_MATCHED_NUM = 3;
	private final int REGION_UNMATCHED_NUM = 0;
