package com.feifan.beacon.service.scanner;
...
import com.feifan.beacon.service.DetectionTracker;
...
public class CycledLeScannerForLollipop extends CycledLeScanner {
    ...
    /*
      ...
      If a com.my.com.my.com.mm.beacon has been seen in the past 10 seconds, don't do any scanning for the between scan period.
         Otherwise:
           - create hardware masks for any com.my.com.my.com.mm.beacon regardless of identifiers
      ...
      This is an improvement over the current state, but the disadvantages are:
         - If a somebody else's com.my.com.my.com.mm.beacon is present and yours is not yet visible when the app is in
      ...
      So the bottom line is it works like this:
         ...
         - If a com.my.com.my.com.mm.beacon is subsequently detected during this low-power scan, it will start a 10-second
            ...
            if (true) {
                ...
                if (mScanDeferredBefore == false) {
                    if (secsSinceLastDetection > BACKGROUND_L_SCAN_DETECTION_PERIOD_MILLIS) {
                        ...
                        // On Android L, between scan cycles do a scan with a filter looking for any com.my.com.my.com.mm.beacon
                        ...
                        LogManager.d(TAG, "This is Android L, but we last saw a com.my.com.my.com.mm.beacon only %s "
                ...
                if (mBackgroundLScanStartTime > 0l) {
                    ...
                    if (DetectionTracker.getInstance().getLastDetectionTime() > mBackgroundLScanStartTime) {
                        ...
                        if (SystemClock.elapsedRealtime() - mBackgroundLScanFirstDetectionTime
                            ...
                            // a com.my.com.my.com.mm.beacon in background L scanning mode.  We need to stop scanning
