...
import com.feifan.bluetooth.BleAdvertisement;
import com.feifan.bluetooth.Pdu;
 ...
 *
 * <p>A <code>BeaconParser</code> may be used to tell the library how to decode a com.my.com.my.com.mm.beacon's fields
 * from a Bluetooth LE advertisement by specifying what byte offsets match what fields, and what
 * byte sequence signifies the com.my.com.my.com.mm.beacon.  Defining a parser for a specific com.my.com.my.com.mm.beacon type may be handled
 ...
 *
 * <p>
 * For more information on how to set up parsing of a com.my.com.my.com.mm.beacon,
...
public class BeaconParser {
    ...
    /**
     * <p>Defines a com.my.com.my.com.mm.beacon field parsing algorithm based on a string designating the zero-indexed
     ...
     *
     * <pre>
     *   m - matching byte sequence for this com.my.com.my.com.mm.beacon type to parse (exactly one required)
     *   s - ServiceUuid for this com.my.com.my.com.mm.beacon type to parse (optional, only for Gatt-based beacons)
     ...
     * this com.my.com.my.com.mm.beacon type.  When multiple i or d entries exist in the string, they will be added in
     * order of definition to the identifier or data array for the com.my.com.my.com.mm.beacon when parsing the com.my.com.my.com.mm.beacon
     ...
     * </pre>
     *
     * <p>This signifies that the com.my.com.my.com.mm.beacon type will be decoded when an advertisement is found with
     ...
     * and operating systems that scan for beacons typically ignore these two bytes, allowing com.my.com.my.com.mm.beacon
     ...
     * com.my.com.my.com.mm.beacon.mManufacturer field.  Matcher expressions should therefore start with "m2-3:" followed
     * by the multi-byte hex value that signifies the com.my.com.my.com.mm.beacon type.
     *
     * @param beaconLayout
    ...
    public BeaconParser setBeaconLayout(String beaconLayout) {
        ...
        Log.d(TAG, "Parsing com.my.com.my.com.mm.beacon layout: "+beaconLayout);
        ...
        for (String term : terms) {
            ...
            while (matcher.find()) {
                ...
                try {
                    ...
                    throw new BeaconLayoutException("Cannot parse com.my.com.my.com.mm.beacon type code: "+hexString+" in term: " + term);
                }
            }
            ...
            if (!found) {
                ...
                throw new BeaconLayoutException("Cannot parse com.my.com.my.com.mm.beacon layout term: " + term);
            }
        }
        if (!mExtraFrame) {
        ...
        if (mMatchingBeaconTypeCodeStartOffset == null || mMatchingBeaconTypeCodeEndOffset == null) {
            throw new BeaconLayoutException("You must supply a matching com.my.com.my.com.mm.beacon type expression with a prefix of 'm'");
        }
     ...
     * accelerated looking for this com.my.com.my.com.mm.beacon type
     *
    ...
    protected Beacon fromScanData(byte[] bytesToProcess, int rssi, BluetoothDevice device, Beacon beacon) {
        ...
        if (pduToParse == null) {
            ...
            if (patternFound == false) {
                // This is not a com.my.com.my.com.mm.beacon
                if (getServiceUuid() == null) {
                    if (LogManager.isVerboseLoggingEnabled()) {
                ...
                if (LogManager.isVerboseLoggingEnabled()) {
                    LogManager.d(TAG, "This is a recognized com.my.com.my.com.mm.beacon advertisement -- %s seen",
                            byteArrayToString(typeCodeBytes));
        ...
        if (parseFailed) {
            ...
            LogManager.e(TAG,beacon.getBluetoothAddress()+" -- "+beacon.getServiceUuid()+" -- "+beacon.getId1().toString());
        }
        return beacon;
    }
     ...
     * @param beacon the com.my.com.my.com.mm.beacon containing the data to be transmitted
    ...
    /**
     * @return the number of identifiers in this com.my.com.my.com.mm.beacon format
     */
    ...
    /**
     * @return the number of data fields in this com.my.com.my.com.mm.beacon format
     */
