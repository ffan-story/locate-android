 ...
 */
package com.feifan.beacon.logging;

/**
 * Logging interface for logging messages in the android-com.my.com.my.com.mm.beacon-library. To set a custom logger
 * implement this interface and set it with {@link com.feifan.beacon.logging.LogManager#setLogger(Logger)}.
 *
 * @author Andrew Reitz
